        ...
        {(props: FormikProps<EnableBeneficiaryDataInterface>) => {
          ...
          return (
            <View style={{ paddingHorizontal: 32 }}>
              <FormikTextField formikBag={props} name='email' contentType='emailAddress' autocompleteType='email' icon='at' label='email_optional' keyboardType='email-address'/>
              ...
              {!props.values.password ? null : (
                <FormikTextField formikBag={props} name='confirmPassword' label='confirm_password' contentType='password' icon='key' displayError />
                )}
              <SecretQuestionPicker fieldName={'question_secrete'} />
              <Separator height={3} />
              {props.values.question_secrete && props.values.question_secrete === 'Autre' ? (
                  <FormikTextField formikBag={props} name='autre_question_secrete' icon='question' label='secret_question_custom_text' autocompleteType='off' />
                  ) : null}
              {!props.values.question_secrete ? null :
                  <FormikTextField formikBag={props} name='reponse_secrete' icon='question-circle' label='secret_answer' autocompleteType='off' />
              }
              <Separator height={6} />
